...
export default function DesktopFloatingActions() {
  ...
  return (
    <>
      ...
      {/* Back to top button - bottom right, above the main FAB */}
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            onClick={scrollToTop}
            className="hidden md:flex fixed bottom-28 right-8 z-50 w-14 h-14 bg-gradient-to-br from-accent to-orange-600 hover:from-orange-600 hover:to-accent rounded-full items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 group"
