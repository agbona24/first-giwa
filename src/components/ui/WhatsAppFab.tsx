...
export default function WhatsAppFab() {
  return (
    <motion.a
      ...
      className="fixed left-4 z-40 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
